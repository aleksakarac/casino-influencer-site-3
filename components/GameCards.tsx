      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-3 gap-5">
          {placeholderGames.map((game, index) => (
            ...
            >
              {/* Card */}
              <div className="relative h-52 rounded-xl overflow-hidden border border-amber-500/20 hover:border-amber-500/50 transition-all duration-300">
                ...
                {/* Tag */}
                <div className="absolute top-3 right-3 px-2.5 py-0.5 bg-amber-500 text-black text-xs font-bold rounded-full">
                  {game.tag}
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                  ...
                  <p className="text-gray-300 text-xs mt-1">Phase 2: Bonus codes will appear here</p>
                </div>
              </div>
            </motion.div>
          ))}
