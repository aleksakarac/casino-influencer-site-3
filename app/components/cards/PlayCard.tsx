...
export function PlayCard({ card, borderColor, vavadaLink }: PlayCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute top-2 right-2 md:top-2 md:right-2 z-10 bg-gradient-to-br from-amber-500 to-yellow-600 p-1.5 md:p-1.5 rounded-md shadow-lg">
        <Gamepad2 size={9} className="md:hidden text-white" />
        <Gamepad2 size={10} className="hidden md:block text-white" />
      </div>
      ...
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 z-20 w-[65%] md:w-[75%]">
        <button
          onClick={(e) => {
            e.preventDefault();
          ...
          className="
            ...
            text-black text-[9px] md:text-[10px] font-bold
            rounded
        ...
        >
          ...
          <Play size={10} className="hidden md:block" fill="currentColor" />
          PLAY NOW
        </button>
      </div>
    </a>
